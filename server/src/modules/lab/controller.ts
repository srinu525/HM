...
export class LabController {
  async getTests(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      const tests = await labService.getTests(req.user!.organizationId as string);
  ...
  async createTest(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      const test = await labService.createTest(req.body, req.user!.organizationId as string);
  ...
  async updateTest(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      const test = await labService.updateTest(req.params.id as string, req.body, req.user!.organizationId as string);
  ...
  async getResults(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      const results = await labService.getResults(req.user!.organizationId as string, {
  ...
  async createResult(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      const result = await labService.createResult({ ...req.body, doctorId: req.user!.id }, req.user!.organizationId as string);
  ...
  async updateResult(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      const result = await labService.updateResult(req.params.id as string, req.body, req.user!.organizationId as string);

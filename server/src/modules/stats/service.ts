...
export class StatsService {
  async getBasicStats(organizationId: string) {
  ...
  async getAppointmentHistory(filters: any, organizationId: string) {
    const where: any = {};
  ...
  async getSalesHistory(filters: any, organizationId: string) {
    const where: any = {};
    if (filters?.startDate && filters?.endDate) {

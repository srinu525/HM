...
async function main() {
    ...
    const users = await prisma.user.findMany({ where: { organizationId: undefined } });
    ...
    const patients = await prisma.patient.findMany({ where: { organizationId: undefined } });
    ...
    const medicines = await prisma.medicine.findMany({ where: { organizationId: undefined } });
    ...
    const notifications = await prisma.notification.findMany({ where: { organizationId: undefined } });

...
export class AdminService {
    async getPlatformStats() {
        ...
        const [totalOrgs, activeOrgs, totalUsers, activeUsers, totalPatients, todayAppointments, todayRevenue, recentPatients, totalMedicines, recentUsers,] = await Promise.all([
    ...
    async setFeatureFlag(organizationId, key, isEnabled) {
    ...
    async setPlatformSetting(key, value, category) {

...
import { Mail, Lock, Hospital, ArrowRight, Shield, Clock, Users } from "lucide-react";
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-2">
              Sign in to <span className="font-medium text-blue-600">{orgSlug.replace(/-/g, " ")}</span>
            </p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              <a href="/patient/login" className="text-blue-600 hover:underline">Patient login</a>
              {" "}·{" "}
